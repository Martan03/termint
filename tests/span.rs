...
mod tests {
    ...
    fn span_new() {
        ...
        assert_eq!(span.to_string(), "New span\x1b[0m");
    ...
    fn span_set_fg() {
        ...
        assert_eq!(span.to_string(), "\x1b[91mSpan fg\x1b[0m");
        ...
        assert_eq!(span.to_string(), "\x1b[90mSpan fg\x1b[0m");
    ...
    fn span_set_bg() {
        ...
        assert_eq!(span.to_string(), "\x1b[107mSpan bg\x1b[0m");
        ...
        assert_eq!(span.to_string(), "\x1b[44mSpan bg\x1b[0m");
    ...
    fn span_modifier() {
        ...
        assert_eq!(span.to_string(), "\x1b[1;3;5;7mSpan modifier\x1b[0m");
